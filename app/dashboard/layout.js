                        ...
                        return(
                            ...
                            >
                                <div className={cn(
                                    ...
                                    isActive ? "bg-gradient-to-r form-purple-600/20 to-blue-600/20 border border-purple-500/20 text-white" : "text-slate-300 hover:text-white hover:bg-slate-700/50"
                                )}>
                                    <item.icon
                                        className={cn(
