...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative pt-24 ">
            ...
            <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
              <div className="space-y-4 sm:space-y-6">
                  <h1 className="text-7xl lg:text-8xl font-black leading-none tracking-tight">
                    ...
                    <span className="block font-light text-purple-300 italic">Publish.</span>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div
                              className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                                activeTab === index ? "bg-gradient-to-r from-purple-500 to-blue-500" : "bg-muted"
                              }`}
                              >
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          {
                            platformTabs[activeTab].features.map((feature,index)=> (
                              <div key={index} className="flex items-center gap-3">
                                <CheckCheck className="w-5 h-5 text-green-400 flex-shrink-0"/>
      ...
      <section id="testimonials" className="relative z-10 mt-48 px-4 sm:px-6 mb-28" >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3  gap-8 ">
                {
                  testimonials.map((testimonial,index) => (
                          <Card key={index} className={"transition-all duration-300 hover:shadow-lg card-glass"}>
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    <Link href={"/dashboard"}>
                      <Button
                        size="xl"
                        variant={"primary"}
                        className={"rounded-full text-white w-full cursor-pointer"}
                      >
                        Start Your Journey
